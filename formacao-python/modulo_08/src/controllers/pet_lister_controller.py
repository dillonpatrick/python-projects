...
from src.models.sqlite.interfaces.pets_repository import \
    PetsRepositoryInterface

from .interfaces.pet_lister_controller import PetListerControllerInterface


class PetListerController(PetsRepositoryInterface):
    ...
    def __format_response(self, pets: list[PetsTable]) -> None:
        formatted_pets = []
