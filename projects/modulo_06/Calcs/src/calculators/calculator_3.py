...
class Calculator3:
    ...
    def __verify_results(self, variance: float, multipliaction: float) -> None:
        if variance < multipliaction:
            raise Exception("Falha no processo: Variância meno que multiplicação")
